  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const enrollRes = await api.get<{ success: boolean; data: any[] }>(
          "/enrollments/my",
        );
          ...
          const reports = await Promise.all(
            sectionIds.map((sectionId) =>
              api
                .get<{
                  success: boolean;
                  data: Omit<SectionSummary, "courseCode" | "courseTitle">;
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Track your class-by-class attendance and course risk level.
            </p>
          </div>
        </div>
              ...
              >
                ...
                <div className="mt-2 flex flex-wrap justify-between gap-2 text-sm text-gray-500">
                  ...
                  <span className="text-gray-400">
                    Limit: {item.absenceLimit} absences
                  </span>
                </div>
              </div>
            ))}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {record.course_code} • Section {record.section_id} •{" "}
                      {formatClassDate(record.date)}
                    </p>
                  </div>
                </div>
                <span
